...
try {
    ...
    # Container overlay filesystems do not reliably surface inotify events for
    # atomic replace operations. Polling makes configuration reload tests and
    # runtime behavior deterministic on Container Apps.
    ...
    switch ($mode) {
        ...
        'playwright' {
            $env:BOTNEXUS_E2E_REQUIRE_FIXTURE = 'true'
